  ...
  Widget build(BuildContext context) {
    return Consumer<VoiceProvider>(
      builder: (context, provider, child) {
        if (provider.state == VoiceState.idle && provider.lastResponse.isEmpty) {
        ...
        return Positioned(
          ...
          child: AnimatedOpacity(
            opacity: provider.state != VoiceState.idle || provider.lastResponse.isNotEmpty ? 1.0 : 0.0,
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (provider.lastResponse.isNotEmpty) ...[
                    if (provider.isRecording || provider.isProcessing || provider.isSpeaking)
                      ...
                      Padding(
                        ...
                        child: Wrap(
                          ...
                          children: [
                            ...
                            if (_isNavigableAction(provider.lastAction) && provider.isSpeaking)
                              const Text(
                    ...
                    if (provider.lastAction == null && provider.lastResponse.isNotEmpty)
                      Padding(
